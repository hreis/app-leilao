...
export class NotificationService {
  ...
  public success(message: string, action = 'Ok', duration = 5000, css = 'success-msg') {
    this.openSnackBar(message, action, css);

  }

  public error(message: string, action = 'Ok', css = 'error-msg') {

    this.openSnackBar(message, action, css);

  }

  public alert(message: string, action = 'Ok', duration = 5000, css = 'alert-msg') {
    this.openSnackBar(message, action, css);
